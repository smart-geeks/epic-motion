          ...
          return (
            <label
              ...
              className={[
                ...
                activo
                  ? 'border-epic-gold bg-epic-gold/10 text-epic-black dark:text-white'
                  : 'border-gray-200 dark:border-white/10 text-gray-600 dark:text-epic-silver hover:border-epic-gold/50',
              ].join(' ')}
            >
              <input
                type="radio"
